...
bin/magento admin:user:create --admin-user=e2e-tests-payment-link --admin-password=password1 --admin-email=e2etestspaymentlink@rvvup.com --admin-firstname=E2E --admin-lastname=PaymentLinks
...
bin/magento admin:user:create --admin-user=e2e-tests-virtual-terminal --admin-password=password1 --admin-email=e2etestsvt@rvvup.com --admin-firstname=E2E --admin-lastname=VirtualTerminal
